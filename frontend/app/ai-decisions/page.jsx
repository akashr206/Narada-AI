...
const AIDecisionLog = () => {
            ...
            <div className="p-3 sm:p-4 md:p-6 space-y-4">
                ...
                <div className="space-y-3 sm:space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 pt-2 sm:gap-3">
                        <Button
                            variant="outline"
                            className="text-xs sm:text-sm h-9 sm:h-10 bg-white dark:bg-slate-800 text-zinc-700 dark:text-zinc-200 border-1-zinc-300 dark:border-1-zinc-600 hover:bg-zinc-50 dark:hover:bg-slate-700"
                        >
                            Approve
                        </Button>
                        <Button
    ...
    return (
        <div className="min-h-screen bg-zinc-50 dark:bg-slate-950 transition-colors">
            {/* Sticky Header */}
            <div className="sticky top-0 z-10 bg-zinc-50 dark:bg-zinc-950 border-1-b border-1-zinc-200 dark:border-1-slate-800 transition-colors">
                <div className="px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 sm:gap-6">
                        <div className="min-w-0">
                            <h1 className="text-3xl sm:text-2xl md:text-3xl font-bold text-zinc-900 dark:text-white mb-1 truncate">
                                AI Decision Log
                            </h1>
                        ...
                        <div className="flex items-center gap-4 sm:gap-6 flex-shrink-0">
                            <div className="text-center sm:text-right">
                                <div className="flex items-center gap-1 sm:gap-2 justify-center sm:justify-end mb-1">
                                    <TrendingUp
                                        ...
                                        className="text-green-500 dark:text-green-400 flex-shrink-0"
                                    />
                                    <span className="text-lg sm:text-2xl md:text-3xl font-bold text-zinc-900 dark:text-white">
                                        {stats.successRate}%
                                    </span>
                                </div>
                            ...
                            <div className="h-8 sm:h-10 w-px bg-zinc-300 dark:bg-zinc-700"></div>
