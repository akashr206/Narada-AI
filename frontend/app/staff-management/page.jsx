...
import StaffMetrics from "@/components/extra/staff-metrics"
import StaffList from "@/components/extra/staff-list"
  ...
  return (
    <div className="w-full px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8">
      ...
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">Staff Management</h1>
