    ...
    const metrics = [
        {
            ...
            value: "1,247",
            bgColor:
                "bg-zinc-100 dark:bg-zinc-800 border-1 border-zinc-400 dark:border-zinc-500",
        ...
        },
        {
            ...
            value: "518",
            bgColor:
                "bg-cyan-100 dark:bg-cyan-950 border-1 border-cyan-700 dark:border-cyan-700",
    ...
    return (
        <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {metrics.map((metric, idx) => (
                <div
                    key={idx}
                    className={`${metric.bgColor} rounded-lg border p-4 sm:p-6 transition-colors`}
                >
