  ...
  const metrics = [
    {
      ...
      title: "Total Staff",
      value: "142",
      bgColor: "bg-gray-100 dark:bg-gray-950 border-1 border-gray-400 dark:border-gray-700",
  ...
  return (
    <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      {metrics.map((metric, idx) => (
        <div key={idx} className={`${metric.bgColor} rounded-lg border border-gray-200 dark:border-gray-700 p-4 sm:p-6 transition-colors`}>
