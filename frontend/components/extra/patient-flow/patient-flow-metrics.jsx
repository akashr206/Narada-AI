  ...
  const metrics = [
    {
      ...
      value: '8',
      icon: Users,
      bgColor: 'bg-blue-50 dark:bg-blue-950  border-1 border-blue-700 dark:border-blue-700',
    ...
    },
    {
      ...
      value: '29m',
      icon: Clock,
      bgColor: 'bg-yellow-50 dark:bg-yellow-950  border-1 border-yellow-700 dark:border-yellow-700',
    ...
    },
    {
      ...
      value: '3',
      icon: AlertTriangle,
      bgColor: 'bg-red-50 dark:bg-red-950  border-1 border-red-700 dark:border-red-700',
    ...
    },
    {
      ...
      value: '1',
      icon: CheckCircle,
      bgColor: 'bg-green-50 dark:bg-green-950  border-1 border-green-700 dark:border-green-700',
          ...
          >
            <div className="flex flex-col sm:flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4">
              <div className="min-w-0">
                ...
                <p className={`text-xl sm:text-2xl md:text-3xl font-bold ${metric.textColor} truncate`}>
                  {metric.value}
                </p>
              </div>
