        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto text-balance">
              Join hospitals optimizing operations with Narada AI's intelligent automation
            </p>
            ...
            >
              <Link href="/signup">
                <MagneticButton
                  className="px-8 py-3 bg-primary text-primary-foreground rounded-lg font-semibold inline-flex items-center justify-center gap-2 hover:bg-primary/90 transition-all duration-300 w-full sm:w-auto shadow-lg shadow-primary/20"
                >
                  Start Free Trial
              ...
              <Link href="/signin">
                <MagneticButton
                  className="px-8 py-3 border border-slate-200 dark:border-slate-800 rounded-lg font-semibold text-foreground hover:bg-secondary/50 transition-all duration-300 w-full sm:w-auto backdrop-blur-sm"
                >
                  Sign In
                </MagneticButton>
              </Link>
