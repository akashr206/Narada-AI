        ...
        <AnimatePresence>
            {openSidebar && (
                <motion.div
                    ...
                    transition={{ type: "tween" }} // removes bounce
                    role="navigation"
                    aria-label="Sidebar"
                    className="z-30 h-screen w-[300px] border-r border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900"
                >
                    <div className="h-20 border-zinc-200 dark:border-zinc-700 px-6 flex items-center justify-between">
